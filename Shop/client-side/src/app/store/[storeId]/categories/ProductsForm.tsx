      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)}>
          <FormField
            ...
            name='images'
            rules={{
              required: 'Загрузите хотя бы 1 картинку',
            }}
            render={(field) => (
              <FormItem>
                <FormLabel>Название</FormLabel>
                <FormControl>
                  <ImageUpload isDisabled={isLoadingCreate || isLoadingUpdate} onChange={field.field} value={field.fieldState}/>
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
              ...
              <FormItem>
                ...
                >
                  ...
                  <SelectContent>
                    <SelectGroup>
                      {colors.map(color => (
                        <SelectItem value={color.id} key={color.id}>{color.name}</SelectItem>
                      ))}
                    </SelectGroup>
                  </SelectContent>
                </Select>
          ...
          <FormField
            ...
            render={({field}) => (
              <FormItem>
                ...
                <FormControl>
                  <Textarea placeholder="Описание магазина" disabled={isLoadingUpdate || isLoadingCreate} {...field}/>
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
