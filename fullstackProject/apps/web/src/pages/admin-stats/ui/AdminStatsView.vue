...
import RevenueChart from '@/entities/stats/ui/RevenueChart.vue';
...
import { BOOKING_STATUSES } from '@/shared/lib/admin-stats';
import { formatPrice, formatRating, formatSession } from '@/shared/lib/format';
