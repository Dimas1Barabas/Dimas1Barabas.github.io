...
| FR-67 | Факторы цены: время суток (утро −20% / вечер +20%), выходной +10%, спрос по доле занятости (−10 / +10 / +25%); цена кратна 10 ₽, clamp занятости в ёмкость, часы — локальное время кинотеатра (TZ); Go-домен и web-зеркало сходятся на одних векторах | High | TC-PRC-001 | ✅ go, web |
| FR-68 | gRPC-контракт cine.pricing.v1 rpc Quote в proto/ монорепо (buf-кодоген, генерат коммитится; proto-loader у API в рантайме, копия в assets/dist); мусорный запрос — InvalidArgument; reflection для grpcurl; клиент API с коротким дедлайном | High | TC-PRC-002 | ✅ go (bufconn), unit |
| FR-69 | Спрос — проекция из событий booking.payment.wait (sessionId+seatsCount) и waitlist.seat.released; retry/parking, poison — пустые ключи/нулевые места; uq(booking_id, kind) гасит redelivery; CTE атомарно ведёт журнал и проекцию, занятость не уходит в минус; память+postgres (embedded schema) | High | TC-PRC-003, TC-PRC-004 | ✅ go (live-PG со скипами) |
| FR-70 | create() спрашивает квот ДО транзакции и занятия мест — сетевой вызов не держит её открытой; чек фиксирует цену момента брони (totalRub = priceRub × места) | High | TC-PRC-005 | ✅ unit, int, e2e |
| FR-71 | Отказоустойчивость: мусор/отказ в ответе Тарификатора — warn и базовая цена афиши, бронь не ломается; витрина GET /sessions/:id/price при деградации — 200 с dynamic:false, не 5xx | High | TC-PRC-006 | ✅ unit, int |
| FR-72 | Витрины и UI: /prices (история квотов с раскладкой) и /demand (проекция спроса) сервиса; блок «Место: N ₽» в модалке — зачёркнутая база, чипы факторов (скидка — зелёный, надбавка — янтарный), бейдж «базовая цена», перезагрузка при изменении занятости живой карты; демо-движок квотит по своей занятости зеркалом, арифметика промо/бонусов — от фактической суммы | Medium | TC-PRC-007, TC-PRC-008, TC-PRC-009 | ✅ int, e2e, web + ✋ витрина Pages |

## Покрытие по уровням

| Уровень | Покрывает требования |
|---|---|
| Юнит (api + web) | FR-2, FR-5, FR-8, FR-10, FR-11, FR-12 (шина), FR-13 (ping), FR-15, FR-16, FR-19, FR-20, FR-21, FR-23, FR-24, FR-25, FR-27, FR-28, FR-30, FR-31, FR-32, FR-33, FR-34, FR-35, FR-37…FR-41, FR-44, FR-45, FR-48, FR-49, FR-51…FR-54, FR-56, FR-57, FR-61, FR-63, FR-64, FR-67…FR-72 |
| Интеграционные | FR-1…FR-6, FR-8…FR-12, FR-18…FR-25, FR-27…FR-35, FR-37…FR-39, FR-41, FR-43…FR-48, FR-51, FR-52, FR-54, FR-55, FR-56, FR-59, FR-60, FR-61, FR-62, FR-65, FR-66, FR-70…FR-72 |
| E2E (стенд) | FR-4, FR-7, FR-9, FR-10, FR-12, FR-18, FR-19, FR-20, FR-22, FR-23, FR-24, FR-25, FR-27…FR-30, FR-32, FR-34, FR-35, FR-37, FR-38, FR-39, FR-41, FR-43, FR-45, FR-46, FR-47, FR-48, FR-51, FR-52, FR-56, FR-60, FR-61, FR-62, FR-65, FR-70, FR-72 |
| Ручные (стенд/UX) | FR-13 (reconnect глазами), FR-14, FR-17, FR-26 (дашборд глазами), FR-30 (письмо глазами), FR-36 (витрина демо), FR-42 (витрина демо), FR-48 (два окна глазами), FR-49 (обрыв на стенде), FR-50 (витрина демо), FR-55 (витрина демо), FR-60 (витрина демо, grpcurl), FR-63 (витрина :18087, grpcurl), FR-66 (баннер демо, гонка cancel-vs-due), FR-72 (витрина демо, grpcurl) |
