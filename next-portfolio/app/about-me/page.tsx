...
const Page = () => {
  return (
    <div className="flex items-center bg-[#0C011A] h-screen overflow-hidden ">
      <div className="pl-20 md:pl-60 flex flex-col gap-3 pb-60 mb:pb-0">
        <h1 className="text-[50px] text-white font-semibold ">
          My Skills<span className='text-red-500'>.</span>
        </h1>
        <p className="max-w-[350px] text-[16px] text-gray-200 md:text-gray-400">
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab aperiam dolore,
          doloremque error facilis hic, nam odit optio pariatur, repellendus sapiente.
        </p>
      </div>
